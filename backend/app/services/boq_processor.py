...
async def process_boq_job(
    ...
    """
    Process a BoQ file asynchronously.

    This is called as a background task from the upload endpoint.
    """
...
- m1 = linear meters"""
    ...
    try:
        ...
        logger.info("gpt4o_vision_request_start", image_count=len(image_contents))
